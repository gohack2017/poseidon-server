...
func main() {
	flag.StringVar(&runMode, "runMode", "development", "poseidon -runMode=[development|test|production]")
	flag.StringVar(&srcPath, "srcPath", "", "poseidon -srcPath=/path/to/source")
	flag.Parse()
